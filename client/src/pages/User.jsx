            ...
            <div className="row justify-content-center">
              <div className="col-lg-11 col-xl-10">
                <div className="page-header mb-4">
                  <div className="media">
                    <img alt="Image" src="assets/img/avatar-male-4.jpg" className="avatar avatar-lg mt-1" />
                    <div className="media-body ml-3">
                      <h1 className="mb-0">David Whittaker</h1>
                      <p className="lead">Interface designer and front-end developer</p>
                    </div>
                  </div>
                </div>
                <ul className="nav nav-tabs nav-fill" role="tablist">
                  <li className="nav-item">
                    <a className="nav-link active" data-toggle="tab" href="#teams" role="tab" aria-controls="teams" aria-selected="true">Teams</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" data-toggle="tab" href="#projects" role="tab" aria-controls="projects" aria-selected="false">Projects</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" data-toggle="tab" href="#tasks" role="tab" aria-controls="tasks" aria-selected="false">Tasks</a>
                  </li>
                </ul>
                <div className="tab-content">
                  <div className="tab-pane fade show active" id="teams" role="tabpanel" data-filter-list="content-list-body">
                    <div className="row content-list-head">
                      <div className="col-auto">
                        <h3>Teams</h3>
                        <button className="btn btn-round" data-toggle="modal" data-target="#team-add-modal">
                      ...
                      <form className="col-md-auto">
                        <div className="input-group input-group-round">
                          ...
                          <input type="search" className="form-control filter-list-input" placeholder="Filter teams" aria-label="Filter teams" />
                        </div>
                      </form>
                    </div>
                          ...
                          <div className="card-body">
                            <div className="dropdown card-options">
                              ...
                              <div className="dropdown-menu dropdown-menu-right">
                                ...
                                <div className="dropdown-divider" />
                                <a className="dropdown-item text-danger" href="#">Leave Team</a>
                              </div>
                            </div>
                            ...
                            <ul className="avatars">
                              ...
                              <li>
                                <a href="#" data-toggle="tooltip" title="Krishna">
                                  <img alt="Krishna Bajaj" className="avatar" src="assets/img/avatar-female-6.jpg" />
                                </a>
                              </li>
                              <li>
                  ...
                  <div className="tab-pane fade" id="projects" role="tabpanel" data-filter-list="content-list-body">
                      ...
                      <div className="row content-list-head">
                        ...
                        <form className="col-md-auto">
                          <div className="input-group input-group-round">
                            ...
                            <input type="search" className="form-control filter-list-input" placeholder="Filter projects" aria-label="Filter Projects" />
                          </div>
                        </form>
                      </div>
                      {/*end of content list head*/}
                      <div className="content-list-body row">
                        <div className="col-lg-6">
                          <div className="card card-project">
                            <div className="card-body">
                              <div className="dropdown card-options">
                                <button className="btn-options" type="button" id="project-dropdown-button-4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <i className="material-icons">more_vert</i>
                                </button>
                                <div className="dropdown-menu dropdown-menu-right">
                              ...
                              <ul className="avatars">
                                <li>
                                  <a href="#" data-toggle="tooltip" title="David">
                                    <img alt="David Whittaker" className="avatar" src="assets/img/avatar-male-4.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Masimba">
                                    <img alt="Masimba Sibanda" className="avatar" src="assets/img/avatar-male-5.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Krishna">
                                    <img alt="Krishna Bajaj" className="avatar" src="assets/img/avatar-female-6.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Harry">
                                    <img alt="Harry Xai" className="avatar" src="assets/img/avatar-male-2.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                              </ul>
                              <div className="card-meta d-flex justify-content-between">
                                ...
                                <span className="text-small" data-filter-by="text">Due 12 days</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="card card-project">
                            ...
                            <div className="card-body">
                              <div className="dropdown card-options">
                                <button className="btn-options" type="button" id="project-dropdown-button-5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <i className="material-icons">more_vert</i>
                                </button>
                                <div className="dropdown-menu dropdown-menu-right">
                                  <a className="dropdown-item" href="#">Edit</a>
                              ...
                              <ul className="avatars">
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Ravi">
                                    <img alt="Ravi Singh" className="avatar" src="assets/img/avatar-male-3.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Masimba">
                                ...
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Peggy">
                                    <img alt="Peggy Brown" className="avatar" src="assets/img/avatar-female-2.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Marcus">
                                    <img alt="Marcus Simmons" className="avatar" src="assets/img/avatar-male-1.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Kerri-Anne">
                                    <img alt="Kerri-Anne Banks" className="avatar" src="assets/img/avatar-female-5.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Claire">
                                    <img alt="Claire Connors" className="avatar" src="assets/img/avatar-female-1.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                              </ul>
                              <div className="card-meta d-flex justify-content-between">
                                ...
                                <span className="text-small" data-filter-by="text">Due 20 days</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="card card-project">
                            <div className="card-body">
                              <div className="dropdown card-options">
                                <button className="btn-options" type="button" id="project-dropdown-button-6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <i className="material-icons">more_vert</i>
                                </button>
                                <div className="dropdown-menu dropdown-menu-right">
                                  <a className="dropdown-item" href="#">Edit</a>
                              ...
                              <ul className="avatars">
                                ...
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Kristina">
                                    <img alt="Kristina Van Der Stroem" className="avatar" src="assets/img/avatar-female-4.jpg" data-filter-by="alt" />
                                  </a>
                                </li>
                              </ul>
                              <div className="card-meta d-flex justify-content-between">
                                ...
                                <span className="text-small" data-filter-by="text">Unscheduled</span>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="tab-pane fade" id="tasks" role="tabpanel" data-filter-list="content-list-body">
                    <div className="row content-list-head">
                      <div className="col-auto">
                        <h3>Tasks</h3>
                      </div>
                ...
                <form className="modal fade" id="team-add-modal" tabIndex={-1} aria-hidden="true">
                  <div className="modal-dialog" role="document">
                    <div className="modal-content">
                      <div className="modal-header">
                        <h5 className="modal-title">New Team</h5>
                      ...
                      <ul className="nav nav-tabs nav-fill" role="tablist">
                        <li className="nav-item">
                          <a className="nav-link active" id="team-add-details-tab" data-toggle="tab" href="#team-add-details" role="tab" aria-controls="team-add-details" aria-selected="true">Details</a>
                        </li>
                        <li className="nav-item">
                          <a className="nav-link" id="team-add-members-tab" data-toggle="tab" href="#team-add-members" role="tab" aria-controls="team-add-members" aria-selected="false">Members</a>
                        </li>
                      </ul>
                      <div className="modal-body">
                        <div className="tab-content">
                          <div className="tab-pane fade show active" id="team-add-details" role="tabpanel">
                            <h6>Team Details</h6>
                            <div className="form-group row align-items-center">
                              <label className="col-3">Name</label>
                              <input className="form-control col" type="text" placeholder="Team name" name="team-name" />
                            </div>
                            <div className="form-group row">
                              <label className="col-3">Description</label>
                              <textarea className="form-control col" rows={3} placeholder="Team description" name="team-description" defaultValue={""} />
                            </div>
                          </div>
                          <div className="tab-pane fade" id="team-add-members" role="tabpanel">
