          ...
          <div className="breadcrumb-bar navbar bg-white sticky-top">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item"><a href="pages-utility.html#">Utility Pages</a>
                </li>
              ...
              <div className="col-lg-3 mb-3">
                <ul className="nav nav-tabs flex-lg-column" role="tablist">
                  <li className="nav-item">
                    <a className="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true">Your Profile</a>
                  </li>
                  <li className="nav-item">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" id="notifications-tab" data-toggle="tab" href="#notifications" role="tab" aria-controls="notifications" aria-selected="false">Email Notifications</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" id="billing-tab" data-toggle="tab" href="#billing" role="tab" aria-controls="billing" aria-selected="false">Billing Details</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" id="integrations-tab" data-toggle="tab" href="#integrations" role="tab" aria-controls="integrations" aria-selected="false">Integrations</a>
                  </li>
                </ul>
              </div>
                    ...
                    <div className="tab-content">
                      <div className="tab-pane fade show active" role="tabpanel" id="profile">
                        <div className="media mb-4">
                          <img alt="Image" src="assets/img/avatar-male-4.jpg" className="avatar avatar-lg" />
                        ...
                        <form>
                          <div className="form-group row align-items-center">
                            ...
                            <div className="col">
                              <input type="text" placeholder="First name" defaultValue="David" name="profile-first-name" className="form-control" required />
                            </div>
                          </div>
                          <div className="form-group row align-items-center">
                            <label className="col-3">Last Name</label>
                            <div className="col">
                              <input type="text" placeholder="First name" defaultValue="Whittaker" name="profile-last-name" className="form-control" />
                            </div>
                          </div>
                          <div className="form-group row align-items-center">
                          ...
                          <div className="form-group row">
                            ...
                            <div className="col">
                              <textarea placeholder="Tell us a little about yourself" name="profile-bio" className="form-control" rows={4} defaultValue={""} />
                      ...
                      <div className="tab-pane fade" role="tabpanel" id="password">
                        <form>
                          <div className="form-group row align-items-center">
                      ...
                      <div className="tab-pane fade" role="tabpanel" id="notifications">
                        <form>
                          <h6>Activity Notifications</h6>
                          <div className="form-group">
                            <div className="custom-control custom-checkbox custom-checkbox-switch">
                              <input type="checkbox" className="custom-control-input" id="notify-1" defaultChecked />
                              <label className="custom-control-label" htmlFor="notify-1">Someone assigns me to a task</label>
                            </div>
                          </div>
                          <div className="form-group">
                            <div className="custom-control custom-checkbox custom-checkbox-switch">
                              <input type="checkbox" className="custom-control-input" id="notify-2" defaultChecked />
                              <label className="custom-control-label" htmlFor="notify-2">Someone mentions me in a conversation</label>
                            </div>
                          </div>
                          <div className="form-group">
                            <div className="custom-control custom-checkbox custom-checkbox-switch">
                              <input type="checkbox" className="custom-control-input" id="notify-3" defaultChecked />
                              <label className="custom-control-label" htmlFor="notify-3">Someone adds me to a project</label>
                            </div>
                          </div>
                          <div className="form-group mb-md-4">
                            <div className="custom-control custom-checkbox custom-checkbox-switch">
                              <input type="checkbox" className="custom-control-input" id="notify-4" />
                              <label className="custom-control-label" htmlFor="notify-4">Activity on a project I am a member of</label>
                            </div>
                          </div>
                          ...
                          <div className="form-group">
                            <div className="custom-control custom-checkbox custom-checkbox-switch">
                              ...
                              <label className="custom-control-label" htmlFor="notify-5">Monthly newsletter</label>
                            </div>
                          </div>
                          <div className="form-group">
                            <div className="custom-control custom-checkbox custom-checkbox-switch">
                              <input type="checkbox" className="custom-control-input" id="notify-6" defaultChecked />
                              <label className="custom-control-label" htmlFor="notify-6">Major feature enhancements</label>
                            </div>
                          </div>
                          <div className="form-group">
                            <div className="custom-control custom-checkbox custom-checkbox-switch">
                              <input type="checkbox" className="custom-control-input" id="notify-7" />
                              <label className="custom-control-label" htmlFor="notify-7">Minor updates and bug fixes</label>
                            </div>
                          </div>
                          <div className="d-flex justify-content-end">
                              ...
                              <div className="row">
                                <div className="col">
                                  ...
                                  <div className="custom-control custom-radio d-inline-block">
                                    ...
                                    <label className="custom-control-label" htmlFor="plan-radio-1" />
                                  </div>
                                </div>
                                <div className="col">
                                  <div className="mb-4">
                                  ...
                                  <div className="custom-control custom-radio d-inline-block">
                                    <input type="radio" id="plan-radio-2" name="customRadio" className="custom-control-input" defaultChecked />
                                    <label className="custom-control-label" htmlFor="plan-radio-2" />
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="card-body">
                              <div className="row align-items-center">
                                <div className="col-auto">
                                  <div className="custom-control custom-radio d-inline-block">
                                    <input type="radio" id="method-radio-1" name="payment-method" className="custom-control-input" defaultChecked />
                                    <label className="custom-control-label" htmlFor="method-radio-1" />
                                  </div>
                                </div>
                                <div className="col-auto">
                                  <img alt="Image" src="assets/img/logo-payment-visa.svg" className="avatar rounded-0" />
                                </div>
                              ...
                              <div className="row align-items-center">
                                <div className="col-auto">
                                  <div className="custom-control custom-radio d-inline-block">
                                    ...
                                    <label className="custom-control-label" htmlFor="method-radio-2" />
                                  </div>
                                </div>
                                <div className="col-auto">
                                  <img alt="Image" src="assets/img/logo-payment-amex.svg" className="avatar rounded-0" />
                                </div>
                                <div className="col d-flex align-items-center">
                                  <span>•••• •••• •••• 9918</span>
                              ...
                              <div className="row align-items-center">
                                <div className="col-auto">
                                  <div className="custom-control custom-radio d-inline-block">
                                    ...
                                    <label className="custom-control-label" htmlFor="method-radio-3" />
                                  </div>
                                </div>
                                <div className="col-auto">
                                  <img alt="Image" src="assets/img/logo-payment-paypal.svg" className="avatar rounded-0" />
                                </div>
                                <div className="col d-flex align-items-center">
                      ...
                      <div className="tab-pane fade" role="tabpanel" id="integrations">
                        <div className="card">
                          <div className="card-body">
                            <div className="row align-items-center">
                              <div className="col">
